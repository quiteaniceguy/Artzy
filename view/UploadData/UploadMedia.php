...
<body>
  ...
  <div id="imageUpload">
	  ...
	  <form action="/Artzy/src/UploadData/uploadImageAction.php" method="post" enctype="multipart/form-data" id = "imageForm">
   ...
   <div id="textUpload">
	  ...
	  <form action="/Artzy/src/UploadData/uploadTextAction.php" method="post" enctype="multipart/form-data" id = "textForm">
   ...
   <div id="audioUpload">
	  ...
	  <form action="/Artzy/src/UploadData/uploadAudioAction.php" method="post" enctype="multipart/form-data" id = "audioForm" >
