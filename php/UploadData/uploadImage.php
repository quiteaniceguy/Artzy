...
<body>
  ...
  <script type="text/javascript">bkLib.onDomLoaded(
	function(){
		new nicEditor().panelInstance('mediaText');
	}
  );</script>
  ...
  <div id="content">
   ...
   <div id="content">
	  <form action="uploadTextAction.php" method="post" enctype="multipart/form-data">
		...
		TEXT:<br><textarea type="text" name="mediaText" rows="10" cols="80" class="upInput" id="mediaText"></textarea><br/>
		GROUPS:<br><textarea type="text" name="groups" rows="1" cols="60" class="upInput"></textarea><br/><br/>
   ...
   <div id="content">
	  <form action="uploadAudioAction.php" method="post" enctype="multipart/form-data">
		...
		AUDIO: <input type="file" name="uploadedAudio" id="uploadedAudio"/><br/>
		<input type="submit" value="post audio"/><br/>
