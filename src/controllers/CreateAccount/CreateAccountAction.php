 <?php
    ...
    try{
		...
		$emailMessage = "<a href='54.191.45.173/Artzy/src/controllers/VerifyAccount/VerifyAccount.php?code={$verificationCode}&userid={$userId}' >" . "Click here to verify your account!" . "</a>";
