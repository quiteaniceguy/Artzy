...
<div id="links" class="pie">
  ...
  <?php
	...
	if($_SESSION["currentId"] != NULL){
		echo "<div id='logo'><span style = 'z-index: 20;' onclick = 'openGeneralGroup()'>the mural.</span></div> ";
		...
		echo "<a id='headerElement' href='/Artzy/index.php?controller=logout&action=home'>LOGOUT</a>";
		echo "<a id='headerElement' href='/Artzy/index.php?controller=uploadMedia&action=home' >UPLOAD </a>";
		echo "<a id='headerElement' href='/Artzy/index.php?controller=profileEditor&action=home'>PROFILE</a>";
		echo "<a id='headerElement' href='/Artzy/index.php?controller=messageViewer&action=home&mailboxType=IN'>MESSAGES</a>";
		echo "<a id='headerElement' href='/Artzy/index.php?controller=muralReview&action=home'>THE MURAL REVIEW</a>";
