...
<script src = '/Artzy/src/javascript/ajax/DeleteMedia.js'></script>
...
<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/Artzy/src/views/Header/Header.php';
	...
	echo  "<p style='font-size: 10vh;' >Hi {$username}!</p>" ."<br/>" ;
...
<div id = 'allPosts'>
	...
	<?php
		...
		$displayResult = $displayMedia->loadMedia($_SESSION["currentId"], $media, 0, $nStartingMedia, 2, $config);
...
<?php
	...
	echo "<span  style = 'position:absoulte; left: 20vw; margin-left: 45vw;' id = \"loadMediaButton\" onClick = \"loadMedia({$_SESSION["currentId"]}, {$displayResult[1]}, 7, 2, jsonMediaArray)\"><b>Load more media</b></span>";
