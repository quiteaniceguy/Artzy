<link rel="stylesheet" href="/Artzy/css/createAcc.css">
...
<div id="leftContainer">
	...
	<div id="acc">join</div>
	<form action="/Artzy/src/controllers/CreateAccount/CreateAccountAction.php" method="post" enctype="multipart/form-data">
